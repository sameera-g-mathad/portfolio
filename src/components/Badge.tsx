...
export const Badge: React.FC<badgeInterface> = ({ className, icon, title, active }) => {
    return <div className={`bg-accent-foreground text-gradient text-muted-foreground border-2 rounded-lg flex justify-center gap-1.5 lg:p-2 p-1 items-center capitalize ${className}`}>
        {icon && icon}
