...
import { Content, Image, ExperienceCard, SectionHeading } from '@/components'
        ...
        <div id='experience' className="w-full h-full">
            ...
            <div className="flex justify-between items-center pt-10">
                ...
                <div className="lg:flex hidden flex-1">
                    <Image alt="Sameer_Gururaj_Mathad_Graduation_2_Image_Placeholder" url="https://i.imgur.com/JpWdHwE.jpeg" />
                </div>
            </div>
        </div>
    </Content>
